...
browser.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:about"]').click(function() {
        ...
        setTimeout(function() {
            $.ajax({
                dataType: 'json',
                url: browser.baseGetData('check4Update',addition),
                async: true,
...
browser.initUploadButton = function() {
    ...
    $('#toolbar').prepend('<div id="upload" style="top:' + top + 'px;width:' + width + 'px;height:' + height + 'px">' +
        '<form enctype="multipart/form-data" method="post" target="uploadResponse" action="' + browser.baseGetData('upload',addition) + '">' +
